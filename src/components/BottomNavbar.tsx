...
export default function BottomNavbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-20 bg-secondary/80 dark:bg-card/80 backdrop-blur-xl border-t border-border z-50 transition-all duration-300">
