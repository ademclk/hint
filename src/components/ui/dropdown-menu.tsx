  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover/70 backdrop-blur-lg border border-border rounded-2xl shadow-lg",
          "[box-shadow:inset_0_1.5px_2.5px_0_rgba(255,255,255,0.77)]",
          "dark:[box-shadow:inset_0_1.5px_2.5px_0_rgba(255,255,255,0.23)]",
          "ring-1 ring-black/5 p-2 min-w-[10rem]",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-accent/60 hover:backdrop-blur-[2px] hover:shadow",
        "focus-visible:ring-0 focus-visible:border-transparent focus-visible:bg-accent/60 focus-visible:backdrop-blur-[3px] focus-visible:shadow",
        ...
        "data-[variant=destructive]:focus-visible:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive",
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "pl-10 hover:bg-accent/60 hover:backdrop-blur-[2px] hover:shadow",
        "focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:bg-accent/60 focus-visible:backdrop-blur-[3px] focus-visible:shadow focus-visible:outline-none",
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "hover:bg-accent/60 hover:backdrop-blur-[2px] hover:shadow",
        "focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:bg-accent/60 focus-visible:backdrop-blur-[3px] focus-visible:shadow focus-visible:outline-none",
        "data-[state=open]:bg-accent/50 data-[inset]:pl-10",
        className
      )}
      {...props}
    >
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover/70 backdrop-blur-lg border border-border rounded-2xl shadow-lg",
        "[box-shadow:inset_0_1.5px_2px_0_rgba(255,255,255,0.17)]",
        "dark:[box-shadow:inset_0_1.5px_2px_0_rgba(255,255,255,0.23)]",
        "ring-1 ring-black/5 p-2 min-w-[10rem] z-50 origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-hidden",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
