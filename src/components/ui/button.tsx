...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: ["border border-border backdrop-blur-[8px] bg-opacity-80 shadow-[0_1.5px_5px_0_rgba(60,60,60,0.09)] [box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.18)] dark:border-border dark:shadow-[0_1.5px_5px_0_rgba(0,0,0,0.25)] dark:[box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.19)]", "bg-primary text-primary-foreground hover:bg-primary/90 active:bg-primary/80"],
        destructive: ["border border-border backdrop-blur-[8px] bg-opacity-80 shadow-[0_1.5px_5px_0_rgba(60,60,60,0.09)] [box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.18)] dark:border-border dark:shadow-[0_1.5px_5px_0_rgba(0,0,0,0.25)] dark:[box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.19)]", "bg-destructive text-white shadow-xs hover:bg-destructive/90 active:bg-destructive/80 focus-visible:ring-destructive/40"],
        outline: ["border border-border backdrop-blur-[8px] bg-opacity-80 shadow-[0_1.5px_5px_0_rgba(60,60,60,0.09)] [box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.18)] dark:border-border dark:shadow-[0_1.5px_5px_0_rgba(0,0,0,0.25)] dark:[box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.19)]", "border-2 border-border bg-background/80 hover:bg-accent/60 hover:text-accent-foreground"],
        ...
        ghost: ["border border-border backdrop-blur-[8px] bg-opacity-80 shadow-[0_1.5px_5px_0_rgba(60,60,60,0.09)] [box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.18)] dark:border-border dark:shadow-[0_1.5px_5px_0_rgba(0,0,0,0.25)] dark:[box-shadow:inset_0_1.5px_1.5px_0_rgba(255,255,255,0.19)]", "bg-transparent text-primary hover:bg-accent/40 hover:text-accent-foreground active:bg-accent/70"],
        link:
