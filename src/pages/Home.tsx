        ...
        <div className="min-h-[calc(100vh-4rem)] flex flex-col">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 py-12 md:py-12 flex flex-col items-center justify-center text-center relative z-10">
                    <h1 className="text-5xl md:text-7xl font-medium tracking-tight mb-4 bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/80">
            ...
            <div className="container mx-auto px-6 py-16 border-b border-border">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-3xl font-medium mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80">
            ...
            <div className="container mx-auto px-6 py-24">
                <h2 className="text-2xl md:text-3xl font-medium text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80">Explore the quantum world</h2>
