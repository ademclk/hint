        ...
        <main className="relative min-h-screen flex flex-col bg-background text-foreground overflow-hidden transition-colors">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <article className="prose prose-lg dark:prose-invert">
                    ...
                    <div ref={el => sectionRefs.current[0] = el} className="mb-16">
                    ...
                    <div ref={el => sectionRefs.current[3] = el} className="mb-16">
                    ...
                    <div ref={el => sectionRefs.current[5] = el} className="mb-16">
                    ...
                    {/* Call to Action */}
                    <div ref={el => sectionRefs.current[6] = el} className="text-center mt-16">
